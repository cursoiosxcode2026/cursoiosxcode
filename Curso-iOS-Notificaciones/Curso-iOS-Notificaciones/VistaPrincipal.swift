...
struct VistaPrincipal: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            //Vamos a escuchar una notificación interna por si el usuario viene de ajustes
            //al conceder o no los permisos
            ...
            .alert("Permisos necesarios", isPresented: $mostrarAlertaAjustes) {
                ...
                Text("Has desactivado las notificaciones. Por favor, actívalas en Ajustes para recivir recordatorios")
            }
