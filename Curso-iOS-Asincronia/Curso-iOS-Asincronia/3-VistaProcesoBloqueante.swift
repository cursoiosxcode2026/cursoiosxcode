...
@State private var estaCalculando = false
    ...
    var body: some View {
        ...
        VStack(spacing:20) {
            ...
            Button("Calcular (bloqueando") {
                ...
                //Ejecuta la funcion en el main thread y lo va a bloquear
            ...
            Button("Calcular con Task") {
                ...
                Task {
                    estaCalculando = true
                    //Como la funcion calculoPesado () no tiene async, tenemos que llamarla
                    //de otra forma
   ...
   //nonisolated hace que la funcion no esté atada a la vista o main thread
