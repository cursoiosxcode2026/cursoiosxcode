...
struct VistaDetalleDestino: View {
    ...
    @State var escalaCorazon: CGFloat = 1.0
...
struct VistaPuntuacion: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading) {
            ...
            // MARK: Estrellitas de puntuacion
            HStack {
...
#Preview {
    @Previewable @State var destino: Destino = Destino(nombre:"New York",icono: "building.2",descripcion: "No está mal, pero hay muchas ratas..", color:.brown, puntuacion: 2)
